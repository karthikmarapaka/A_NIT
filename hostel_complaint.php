...
<html>
    <head>
        ...
        <title>Hostel Maintenance Complaints | A_NIT</title>
...
#id01,#id02 {
    ...
    <body class="background" style="overflow-x:hidden;">
        ...
        <div class="row">
            ...
            <div>
                <button class="btn btn-primary" style="width:auto; ">
                    <a href="hostel_complaint_input" style="text-decoration: none; color:white;">Give your complaint</a>
                </button>
        ...
        <?php 
        $r="SELECT * FROM hostel_complaints";
