...
<html>
    <head>
        ...
        <title>College Maintenance Complaints | A_NIT</title>
    ...
    <body class="background" style="overflow-x:hidden;">
        ...
        <div class="row">
            ...
            <div>
                    ...
                    <a href="college_complaint_input.php" style="text-decoration: none; color:white;">
        ...
        <?php 
        $r="SELECT * FROM college_complaints";
