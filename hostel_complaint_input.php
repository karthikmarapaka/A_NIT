...
<html>
    <head>
        ...
        <title>Hostel Maintenace Complaints Input | A_NIT</title>
...
if($_POST['submit1']=='Submit'){
    $u=mysqli_real_escape_string($a,$_POST['ask_query1']);
        ...
        $u2="INSERT INTO hostel_complaints(info_hc,reg_no_hc) VALUES('$u','$reg_no_c')";
        if($u4=mysqli_query($a,$u2)){
            {      echo "<script type='text/javascript'>window.location.href = 'hostel_complaint.php';</script>";
    ...
    $u1=mysqli_real_escape_string($a,$_POST['ask_query2']);
        ...
        $u3="INSERT INTO hostel_complaints(info_hc,reg_no_hc) VALUES('$u1','unknown')";
...
//            $message="Submitted successfully";
  ...
  <form method='post' id="id01" action="hostel_complaint_input.php" name="submit1">
    <div class="container">
      <h2 style='color:black;'>Complaint about Hostel Maintenance</h2>
  ...
  <form method='post' action="hostel_complaint_input.php" name="submit2" id="id02">
    <div class="container">
      <h2 style='color:black;'>Complaint about Hostel Maintenance(Anonymous)</h2>
         <div class="row">
          <div class="row">
                           <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
