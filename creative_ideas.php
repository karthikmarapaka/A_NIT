...
#id01,#id02 {
    ...
    <body class="background" style="overflow-x:hidden;">
        ...
        <div class="row">
            ...
            <div>
                <button class="btn btn-primary" style="width:auto; ">
                    <a href="creative_ideas_input.php" style="text-decoration: none; color:white;">Submit your idea</a>
                </button>
        ...
        <?php 
        $r="SELECT * FROM creative_ideas";
        if($sr=mysqli_query($a,$r))
                                {                                     
                    while($row=mysqli_fetch_array($sr))
                            { ?> <div class="container"><div style="color:white;"><?php echo $row[1]; ?></div>
                                <div style="color:white;" class="col-md-offset-10 col-sm-offset-6 col-xs-offset-6 col-lg-offset-10">-----------<?php echo $row[2]; ?></div>
