...
<html>
    <head>
        ...
        <title>Ragging Complaints | A_NIT</title>
...
#id01,#id02 {
    ...
    <body class="background" style="overflow-x:hidden;">
        ...
        <div class="row">
            ...
            <div>
                <button class="btn btn-primary" style="width:auto; ">
                    <a href="ragging_complaint_input.php" style="text-decoration: none; color:white;">Give your complaint(Anonymous)</a>
                </button>
        ...
        <?php 
        $r="SELECT * FROM ragging_complaints";
        if($sr=mysqli_query($a,$r))
                                {                                     
                    while($row=mysqli_fetch_array($sr))
                            { ?> <div class="container"><div style="color:black;"><?php echo $row[1]; ?></div>
                                <div style="color:yellow;" class="col-md-offset-9 col-sm-offset-2 col-xs-offset-2 col-lg-offset-9">---<?php echo $row[2]; ?></div>
