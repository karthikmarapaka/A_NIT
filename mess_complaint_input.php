...
<html>
    <head>
        ...
        <title>Mess Complaints Input | A_NIT</title>
...
if($_POST['submit1']=='Submit'){
    $u=mysqli_real_escape_string($a,$_POST['ask_query1']);
        ...
        $u2="INSERT INTO mess_complaints(info_mc,reg_no_mc) VALUES('$u','$reg_no_c')";
        if($u4=mysqli_query($a,$u2)){
            {      echo "<script type='text/javascript'>window.location.href = 'mess_complaint.php';</script>";
    ...
    $u1=mysqli_real_escape_string($a,$_POST['ask_query2']);
        ...
        $u3="INSERT INTO mess_complaints(info_mc,reg_no_mc) VALUES('$u1','unknown')";
...
//            $message="Submitted successfully";
  ...
  <form method='post' id="id01" action="mess_complaint_input.php" name="submit1">
    <div class="container">
      <h1 style='color:black;'>Complaint about Mess</h1>
  ...
  <form method='post' action="mess_complaint_input.php" name="submit2" id="id02">
    <div class="container">
      <h1 style='color:black;'>Complaint about Mess(Anonymous)</h1>
         <div class="row">
          <div class="row">
                           <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
